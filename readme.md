# Awesome J2ME [![Awesome](https://awesome.re/badge.svg)](https://awesome.re) with stars
...
Please give it a star(⭐) to raise awareness about J2ME community, and support the development of this project. Read about introduction, setup-process, and history of Awesome J2ME in <a href="https://hstsethi.vercel.app/posts/programming/awesome-j2me">this blog post</a>. Also check out [Awesome Symbian](https://github.com/hstsethi/awesome-symbian) ⭐ 77 | 🐛 1 | 🌐 Java | 📅 2025-11-28.

<!--lint disable double-link-->

Proud to be featured in [Awesome](https://github.com/sindresorhus/awesome) ⭐ 435,724 | 🐛 67 | 📅 2026-01-28, [Hackclub](https://retrospect.hackclub.com/j2me), [Awesome Java](https://github.com/akullpp/awesome-java) ⭐ 46,950 | 🐛 2 | 📅 2026-02-07 and more.
...
* [NN JSON CLDC 1.0](https://github.com/gtrxAC/discord-j2me/tree/main/src/cc/nnproject/json) ⭐ 395 | 🐛 12 | 🌐 Java | 📅 2026-02-06 - Modified version of NN JSON for CLDC 1.0.
...
* [J2ME Loader](https://github.com/nikita36078/J2ME-Loader) ⭐ 2,472 | 🐛 212 | 🌐 Java | 📅 2026-02-06 - J2ME emulator for Android.
* [FreeJ2ME](https://github.com/hex007/freej2me) ⭐ 611 | 🐛 65 | 🌐 Java | 📅 2026-01-13 - J2ME emulator with LibRetro, AWT and SDL2 frontends.
* [KEmulator nnmod](https://github.com/shinovon/KEmulator) ⭐ 331 | 🐛 77 | 🌐 Java | 📅 2026-02-01 - Open source J2ME emulator in Java, based on KEmulator 1.0.3.
* [SquirrelJME](https://github.com/squirreljme/squirreljme) ⭐ 298 | 🐛 57 | 🌐 Java | 📅 2026-02-06 - Java ME 8 Virtual Machine for embedded and Internet of Things devices.
...
* [FreeJ2ME Plus](https://github.com/TASEmulators/freej2me-plus) ⭐ 120 | 🐛 28 | 🌐 Java | 📅 2025-12-29 - Active fork of FreeJ2ME.
...
* [Discord J2ME](https://github.com/gtrxAC/discord-j2me) ⭐ 395 | 🐛 12 | 🌐 Java | 📅 2026-02-06 - Unofficial Discord client for J2ME. Utilizes a proxy server for HTTP and gateway connections.
...
* [Gravity Defied CPP](https://github.com/rgimad/gravity_defied_cpp) ⭐ 155 | 🐛 8 | 🌐 C++ | 📅 2025-05-12 - C++, SDL2 port of J2ME game of the same name.
...
* [Awesome Symbian](https://github.com/hstsethi/awesome-symbian) ⭐ 77 | 🐛 1 | 🌐 Java | 📅 2025-11-28 - An Awesome List about everything related to Symbian, a discontinued mobile OS for ARM popular in the early 2000s. It supports J2ME applications.
...
* [Recaf](https://github.com/Col-E/Recaf) ⭐ 6,993 | 🐛 97 | 🌐 Java | 📅 2026-02-06 - Bytecode editor that supports multiple decompilers.
* [Fernflower](https://github.com/fesh0r/fernflower) ⭐ 4,159 | 🐛 0 | 🌐 Java | 📅 2026-02-06 - Analytical Java decompiler by JetBrains.
* [Vineflower](https://github.com/vineflower/vineflower) ⭐ 1,956 | 🐛 86 | 🌐 Java | 📅 2026-01-19 - Fork of Fernflower decompiler with improved output quality.
